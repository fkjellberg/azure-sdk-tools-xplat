...
exports.init = function(cli) {
  ...
  diagnostic.command("tail [name]").whiteListPowershell().description("Live diagnostic log").option("-s, --subscription <id>", "use the subscription id").option("-p, --path <path>", "the log path under LogFiles folder").option("-f, --filter <filter>", "filter matching line").execute(function __2(name, options, _) { var context, repositoryUri, buf; var __frame = { name: "__2", line: 80 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      return site.ensureRepositoryUri(context, __cb(_, __frame, 10, 26, function ___(__0, __1) { repositoryUri = __1; return (function __$__2(__then) {
          if (repositoryUri) {
            return doLogStream(context, __cb(_, __frame, 12, 18, function ___(__0, __2) { buf = __2;
  ...
  function doDownloadDiagnostic(context, _) { var channel, progress; var __frame = { name: "doDownloadDiagnostic", line: 102 }; return __func(_, this, arguments, doDownloadDiagnostic, 1, __frame, function __$doDownloadDiagnostic() {
  ...
  function doLogStream(context, _, chunkcb) { var channel; var __frame = { name: "doLogStream", line: 113 }; return __func(_, this, arguments, doLogStream, 1, __frame, function __$doLogStream() {
      ...
      return channel.GET(__cb(_, __frame, 10, 11, _, true), chunkcb); }); };};