...
exports.init = function (cli) {
  ...
  affinityGroup.command('create <name>')
    ...
    .execute(function (name, options, callback) {
      ...
      utils.doServiceManagementOperation(channel, 'createAffinityGroup', name, affinityGroupOptions, function (error, response) {
        progress.end();
  ...
  affinityGroup.command('delete <name>')
    ...
    .execute(function (name, options, callback) {
      ...
      utils.doServiceManagementOperation(channel, 'deleteAffinityGroup', name, function (error, response) {
        progress.end();
